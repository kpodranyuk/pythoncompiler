...
| CONTINUE line_sep {$$ = createFromSingleStatement(__CONTINUE); printf("BISON:\tfound stmt continue:\t\n"); fprintf(logFileB,"BISON:\tfound stmt_continue:\t\n");}
| BREAK line_sep {$$ = createFromSingleStatement(__BREAK); printf("BISON:\tfound stmt break:\t\n"); fprintf(logFileB,"BISON:\tfound stmt_break:\t\n");}
| RETURN expr line_sep {$$ = createFromSingleStatement(__RETURN); printf("BISON:\tfound stmt return:\t\n"); fprintf(logFileB,"BISON:\tfound stmt_return:\t\n");}
| DEL OPERAND line_sep {$$ = createFromSingleStatement(__DEL); printf("BISON:\tfound expr: DEL_stmt\n"); fprintf(logFileB,"BISON:\tfound expr: DEL_stmt\n");}
