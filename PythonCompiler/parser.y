...
| FFLOAT		{$$=createValNode(_FLOAT,false,NULL,NULL,$1,createCodeLocation(@1.first_line,@1.first_column,@1.last_line,@1.last_column));			/*printf("BISON:\tfound var_val: FLOAT\n");*/ fprintf(logFileB,"BISON:\tfound var_val: FLOAT\n");}
;
