...
enum OperType
{
	__BIPUSH = 16,	// АРГУМЕНТ С1
	__SIPUSH = 17,	// АРГУМЕНТ С2
	_ICONST = 2,
	__LDC = 18,				// Загружает на стек целую константу из таблицы констант. Аргумент - # на Constant_Integer - u1
	__LDC_W = 19,			// Загружает на стек дробную константу из таблицы констант. Аргумент - # на Constant_FLOAT - u2
	...
	__IF_NE = 154,			// Условный переход, если условие не верно. Аргумент - смещение s2
	// --
